...
build: header rebuildHeader get_Makefile build_464lib header
	@echo "*********************************************"
	
cleanBuild: header rebuildHeader clean_464lib clean_464lib_src get_464lib get_Makefile build_464lib header
...
rebuildHeader:
	@echo "Building CPE 464 Library: $(CPE464_LIB)"
	@echo "NOT retrieving a new version of the code"
	@echo ""
	
clean_464lib_src:
	@echo "*********************************************" 
	@echo " Removing CPE 464 Library Source... " 
	rm -rf $(LIBPATH)/ cpe464.h	
	@echo ""
